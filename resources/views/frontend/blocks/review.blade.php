<div class="well">
    ...
    <div class="row well2">
        ...
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
            ...
            <input class="form-control" type="text" name="email" style="width:100%;"required autofocus>
            <p id="email-error" style="color:red;"></p>
            <p>Đánh giá:</p>
            <textarea  class="form-control" type="text" rows="5" cols="44" name="content" style="display:block;"required autofocus></textarea>
